-- A school may represent Day Care as a grade with section A, or use a grade
-- label such as "Day Care A". Both must be eligible for the per-child plan.
-- This forward-only replacement keeps historical plans and invoices intact.
