...
void main() {
  test('leave handler self-heals missing leave types and avoids blank uuid inserts', () {
    final source = File(
    ...
    expect(source, contains('const defaultLeaveTypeId = text(leaveTypes[0]?.id);'));
    expect(source, contains('leave_type_id: text(body.leave_type_id) || defaultLeaveTypeId || null'));
