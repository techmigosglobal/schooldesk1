...
export const metadata: Metadata = { title: "About Us", description: "Meet ArishVille Preschool, a warm and playful early-learning community built for big beginnings.", alternates: { canonical: "/about-us" } };

export default function AboutUsPage() {
  return <PublicPage>
    <section className="page-hero about-hero"><p className="eyebrow">Welcome to ArishVille</p><h1>A little world built for big beginnings.</h1><p>ArishVille Preschool is a warm, happy place where children are encouraged to wonder, create, connect, and grow at their own beautiful pace.</p></section>
    ...
    <section className="callout"><div><p className="eyebrow">A place to belong</p><h2>Ready for your child’s next little adventure?</h2></div><Link className="primary-button" href="/gallery">Step inside ArishVille</Link></section>
  </PublicPage>;
}
