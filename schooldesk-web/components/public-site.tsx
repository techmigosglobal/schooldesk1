...
export function PublicHeader() {
  return <header className="public-nav">
    ...
    <Link className="outline-button" href="/login/principal">Staff login</Link>
  </header>;
}
...
export function PublicFooter() {
  return <footer className="site-footer">
    <div className="footer-main">
      ...
      <nav className="footer-links" aria-label="Explore ArishVille"><b>Explore</b><Link href="/">Home</Link><Link href="/about-us">About Us</Link><Link href="/our-mission">Our Mission</Link><Link href="/gallery">School Gallery</Link></nav>
      <nav className="footer-links" aria-label="SchoolDesk access"><b>SchoolDesk</b><Link href="/login/principal">Principal portal</Link><Link href="/login/coordinator">Coordinator portal</Link><a href="#top">Back to top ↑</a></nav>
    </div>
