...
export function PublicHeader() {
  ...
  return <header className="public-nav">
    <Link className="brand-lockup" href="/" aria-label="Arish Ville Preschool home">
      ...
      <span><b>Arish Ville</b><small>Preschool</small></span>
    </Link>
...
export function PublicFooter() {
  return <footer className="site-footer">
    <div className="footer-main">
      <div className="footer-brand"><Image src="/branding/arishville-logo.png" alt="Arish Ville Preschool" width={54} height={54}/><div><b>Arish Ville Preschool</b><span>Learn Today, Lead Tomorrow.</span><p>A happy first home for curiosity, confidence, and friendship.</p></div></div>
      <nav className="footer-links" aria-label="Explore Arish Ville"><b>Explore</b><Link href="/">Home</Link><Link href="/about-us">About</Link><Link href="/programs">Programs</Link><Link href="/admissions">Admissions &amp; Contact</Link><Link href="/gallery">School Gallery</Link></nav>
