...
const heroSlides: HeroSlide[] = [
  { eyebrow: "Arish Ville Preschool", title: "Learn Today, Lead Tomorrow.", body: "At Arish Ville Preschool, little learners are encouraged to explore, create, and grow with confidence.", link: "/about-us", action: "Meet Arish Ville", theme: "welcome" },
...
export function HomeHero({ heroTitle, heroBody }: { heroTitle: string; heroBody: string }) {
  ...
  return <section className={`hero hero-${slide.theme}`} aria-roledescription="carousel" aria-label="Arish Ville Preschool highlights" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
