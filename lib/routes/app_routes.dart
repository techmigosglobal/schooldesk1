...
class AppRoutes {
  ...
  static const String principalChatCommunications = '/principal-chat-communications-screen';
  ...
  static const String academicSubjectForm = '/academic-management-screen/subject';
  static const String academicClassForm = '/academic-management-screen/class';
  static const String academicCurriculumForm = '/academic-management-screen/curriculum';
  ...
  static const String principalUserManagement = '/principal-user-management-screen';
  ...
  static const String principalAccountCreate = '/principal-user-management-screen/create';
  static const String principalAccountEdit = '/principal-user-management-screen/edit';
  static const String principalParentChildAssignment = '/principal-user-management-screen/assign-children';
  static const String principalSchoolProfile = '/principal-school-profile-screen';
  ...
  // Admin Module Routes
  static const String adminAccountCreate = '/admin-user-management-screen/create';
  static const String adminAccountEdit = '/admin-user-management-screen/edit';
  static const String adminParentChildAssignment = '/admin-user-management-screen/assign-children';
  ...
  static const String adminExamScheduleForm = '/admin-exams-screen/schedule-form';
  static const String adminFeeStructureForm = '/admin-fees-screen/fee-structure';
  static const String adminInvoiceGenerationForm = '/admin-fees-screen/invoice-generation';
  static const String adminPaymentRecordForm = '/admin-fees-screen/payment-record';
  static const String adminPaymentRequests = '/admin-fees-screen/payment-requests';
  static const String adminPaymentRequestDecision = '/admin-fees-screen/payment-request-decision';
  static const String adminTimetableGenerationForm = '/admin-timetable-screen/generation';
  static const String adminTimetablePeriodForm = '/admin-timetable-screen/period';
  static const String adminTimetableSubstitutionForm = '/admin-timetable-screen/substitution';
  ...
  static const String teacherAttendanceHistory = '/teacher-attendance-history-screen';
  ...
  static const String teacherStudyMaterialForm = '/teacher-study-materials-screen/form';
  static const String teacherCommunication = '/teacher-communication-screen';
  static const String teacherParentInteraction = '/teacher-parent-interaction-screen';
  ...
  static const String parentAcademicProgress = '/parent-academic-progress-screen';
  ...
  static const String parentPaymentSelection = '/parent-fees-screen/payment-selection';
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    principalChatCommunications: (context) => const PrincipalChatCommunicationsScreen(),
    ...
    academicManagement: (context) => const AcademicManagementScreen(ownerRole: 'principal'),
    academicYearForm: (context) => AcademicYearFormScreen(args: _academicYearFormArgs(context)),
    academicSubjectForm: (context) => AcademicSubjectFormScreen(args: _academicSubjectFormArgs(context)),
    academicClassForm: (context) => AcademicClassFormScreen(args: _academicClassFormArgs(context)),
    academicCurriculumForm: (context) => AcademicCurriculumFormScreen(args: _academicCurriculumFormArgs(context)),
    principalAcademicInfo: (context) => AcademicInfoScreen(
      role: 'principal',
      drawer: PrincipalDrawer(selectedIndex: 5, onDestinationSelected: (_) {}),
      drawerIndex: 5,
    ),
    principalUserManagement: (context) => const AdminUserAccessScreen(ownerRole: 'principal'),
    guardianDirectory: (context) => const GuardianDirectoryScreen(ownerRole: 'principal'),
    ...
    principalAccountCreate: (context) => AccountAccessFormScreen(args: _accountFormArgs(context, 'principal')),
    principalAccountEdit: (context) => AccountAccessFormScreen(args: _accountFormArgs(context, 'principal')),
    ...
    adminAccountCreate: (context) => AccountAccessFormScreen(args: _accountFormArgs(context, 'admin')),
    adminAccountEdit: (context) => AccountAccessFormScreen(args: _accountFormArgs(context, 'admin')),
    ...
    adminExamForm: (context) => AdminExamFormScreen(args: _adminExamFormArgs(context)),
    adminExamScheduleForm: (context) => AdminExamScheduleFormScreen(args: _adminExamScheduleFormArgs(context)),
    adminFeeStructureForm: (context) => AdminFeeStructureFormScreen(args: _adminFeeStructureFormArgs(context)),
    adminInvoiceGenerationForm: (context) => AdminInvoiceGenerationFormScreen(args: _adminInvoiceGenerationFormArgs(context)),
    adminPaymentRecordForm: (context) => AdminPaymentRecordFormScreen(args: _adminPaymentRecordFormArgs(context)),
    adminPaymentRequests: (context) => const AdminPaymentRequestsScreen(),
    adminPaymentRequestDecision: (context) => AdminPaymentRequestDecisionScreen(args: _adminPaymentRequestDecisionArgs(context)),
    adminTimetableGenerationForm: (context) => AdminTimetableGenerationFormScreen(args: _adminTimetableGenerationFormArgs(context)),
    adminTimetablePeriodForm: (context) => AdminTimetablePeriodFormScreen(args: _adminTimetablePeriodFormArgs(context)),
    adminTimetableSubstitutionForm: (context) => AdminTimetableSubstitutionFormScreen(args: _adminTimetableSubstitutionFormArgs(context)),
    ...
    teacherAttendanceHistory: (context) => const TeacherAttendanceHistoryScreen(),
    teacherMyAttendance: (context) => const TeacherMyAttendanceScreen(),
    teacherHomework: (context) => const TeacherHomeworkScreen(),
    teacherHomeworkForm: (context) => TeacherHomeworkFormScreen(args: _teacherHomeworkFormArgs(context)),
    teacherHomeworkSubmissions: (context) => TeacherHomeworkSubmissionsScreen(args: _teacherHomeworkSubmissionsArgs(context)),
    teacherStudyMaterials: (context) => const TeacherStudyMaterialsScreen(),
    teacherStudyMaterialForm: (context) => const TeacherStudyMaterialFormScreen(),
    teacherCommunication: (context) => const TeacherCommunicationScreen(),
    teacherLeave: (context) => const TeacherLeaveScreen(),
    teacherLeaveRequestForm: (context) => TeacherLeaveRequestFormScreen(args: _teacherLeaveFormArgs(context)),
    ...
    parentHomeworkSubmit: (context) => ParentHomeworkSubmissionScreen(args: _parentHomeworkSubmissionArgs(context)),
    ...
    parentPaymentRequestForm: (context) => ParentPaymentRequestFormScreen(args: _parentPaymentFormArgs(context)),
    parentPaymentSelection: (context) {
      final args = _parentPaymentSelectionArgs(context);
      return ParentPaymentSelectionScreen(fees: args.fees, student: args.student);
    },
    parentLeave: (context) => const ParentLeaveScreen(),
    parentLeaveRequestForm: (context) => ParentLeaveRequestFormScreen(args: _parentLeaveFormArgs(context)),
    ...
    notificationCenter: (context) {
      final role = ModalRoute.of(context)?.settings.arguments as String? ?? 'principal';
  ...
  static AccountAccessFormArgs _accountFormArgs(BuildContext context, String fallbackOwnerRole) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AccountAccessFormArgs) return args;
    return AccountAccessFormArgs(ownerRole: fallbackOwnerRole);
  }

  static AccountChildAssignmentArgs _childAssignmentArgs(BuildContext context, String fallbackOwnerRole) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AccountChildAssignmentArgs) return args;
    return AccountChildAssignmentArgs(ownerRole: fallbackOwnerRole, parentUserId: '', parentName: 'Parent', parentEmail: '');
  }
  ...
  static AcademicSubjectFormArgs _academicSubjectFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
  ...
  static AcademicCurriculumFormArgs _academicCurriculumFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AcademicCurriculumFormArgs) return args;
    return const AcademicCurriculumFormArgs(ownerRole: 'principal', classes: [], subjects: []);
  }
  ...
  static TeacherHomeworkFormArgs _teacherHomeworkFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is TeacherHomeworkFormArgs) return args;
    return const TeacherHomeworkFormArgs(teacherStaffId: '', defaultClassName: 'Not assigned', defaultSubject: 'General', assignedClasses: [], students: []);
  }

  static TeacherHomeworkSubmissionsArgs _teacherHomeworkSubmissionsArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is TeacherHomeworkSubmissionsArgs) return args;
    return const TeacherHomeworkSubmissionsArgs(homework: {});
  }

  static ParentHomeworkSubmissionArgs _parentHomeworkSubmissionArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is ParentHomeworkSubmissionArgs) return args;
    return const ParentHomeworkSubmissionArgs(homework: {}, studentId: '', studentName: 'Student');
  }

  static TeacherLeaveRequestFormArgs _teacherLeaveFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is TeacherLeaveRequestFormArgs) return args;
    return const TeacherLeaveRequestFormArgs(staffId: '', staffName: '', leaveTypes: [], balances: []);
  }

  static ParentPaymentRequestFormArgs _parentPaymentFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is ParentPaymentRequestFormArgs) return args;
    return const ParentPaymentRequestFormArgs(fees: []);
  }

  static ParentPaymentSelectionArgs _parentPaymentSelectionArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is ParentPaymentSelectionArgs) return args;
    if (args is Map<String, dynamic>) {
      return ParentPaymentSelectionArgs(
        fees: (args['fees'] as List?)?.map((e) => Map<String, dynamic>.from(e as Map)).toList() ?? [],
  ...
  static AdminExamScheduleFormArgs _adminExamScheduleFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminExamScheduleFormArgs) return args;
    return const AdminExamScheduleFormArgs(exams: [], grades: [], sections: [], subjects: []);
  }

  static AdminFeeStructureFormArgs _adminFeeStructureFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminFeeStructureFormArgs) return args;
    return const AdminFeeStructureFormArgs(academicYears: [], grades: [], feeCategories: []);
  }

  static AdminInvoiceGenerationFormArgs _adminInvoiceGenerationFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminInvoiceGenerationFormArgs) return args;
    return const AdminInvoiceGenerationFormArgs(academicYears: [], grades: [], sections: [], students: [], feeStructures: []);
  }

  static AdminPaymentRecordFormArgs _adminPaymentRecordFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminPaymentRecordFormArgs) return args;
    return const AdminPaymentRecordFormArgs(pendingDues: []);
  }

  static AdminPaymentRequestDecisionArgs _adminPaymentRequestDecisionArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminPaymentRequestDecisionArgs) return args;
    return const AdminPaymentRequestDecisionArgs(request: {});
  }

  static AdminTimetableGenerationFormArgs _adminTimetableGenerationFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminTimetableGenerationFormArgs) return args;
    return const AdminTimetableGenerationFormArgs(classLabel: '', section: null, academicYear: null, termId: '', dayLabel: 'Monday', dayNumber: 1);
  }

  static AdminTimetablePeriodFormArgs _adminTimetablePeriodFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminTimetablePeriodFormArgs) return args;
    return const AdminTimetablePeriodFormArgs(classLabel: '', section: null, academicYear: null, termId: '', dayLabel: 'Monday', dayNumber: 1, nextPeriodNumber: 1, subjects: [], staff: [], rooms: []);
  }

  static AdminTimetableSubstitutionFormArgs _adminTimetableSubstitutionFormArgs(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    if (args is AdminTimetableSubstitutionFormArgs) return args;
    return const AdminTimetableSubstitutionFormArgs(classLabel: '', dayLabel: 'Monday', periods: [], staff: []);
  }
}
