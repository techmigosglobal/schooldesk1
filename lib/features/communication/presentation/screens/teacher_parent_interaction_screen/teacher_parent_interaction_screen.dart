  ...
  final isDesktop = DesktopBreakpoints.isDesktopWidth(
      ...
      if (isDesktop) {
        ...
        return DesktopScreenWrapper(
          ...
          breadcrumbs: ['Communication', 'Parent Interaction'],
              ...
              child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Parent Interaction', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700)),
