  ...
  final isDesktop = DesktopBreakpoints.isDesktopWidth(
      ...
      if (isDesktop) {
        ...
        return DesktopScreenWrapper(
          ...
          breadcrumbs: ['Homework', 'Messages'],


          title: 'Homework Messages',
              ...
              child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Homework Messages', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700)),
