              ...
              child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Staff Management', style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700)),
            ...
            child: ListView(
              ...
              children: [
                _DirectoryChip(
                  label: 'All Staff',
                  selected:
                      _selectedDesignation == 'All' && _selectedStatus == 'All',
                  onTap: () {
                    _selectedDesignation = 'All';
                    _selectedStatus = 'All';
                    _applyFilters();
