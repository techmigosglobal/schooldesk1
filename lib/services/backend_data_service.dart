  ...
  Future<List<Map<String, dynamic>>> getList(String key) async {
    switch (key) {
      ...
      case kParentChildren:
        return (await _api.getStudents(page: 1, pageSize: 100)).data
            .map(
              (s) => {
                'id': s.id,
                'name': s.fullName,
            ...
            .toList();
      case kAdminTeachers:
        return (await _api.getStaff(page: 1, pageSize: 100)).data
            .map(
              (s) => {
                'id': s.id,
                'name': s.fullName,
      ...
      case kAdminAttendanceRecords:
        final students = (await _api.getStudents(page: 1, pageSize: 100)).data;
