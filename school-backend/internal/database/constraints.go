...
func relationshipConstraintStatements() []string {
	return []string{
		...
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_sections_school_year_grade_name ON sections (school_id, academic_year_id, grade_id, lower(section_name));",
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_grade_subjects_school_year_grade_subject ON grade_subjects (school_id, academic_year_id, grade_id, subject_id);",
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_staff_subjects_school_year_staff_subject_grade_section ON staff_subjects (school_id, academic_year_id, staff_id, subject_id, grade_id, COALESCE(section_id, ''));",
		...
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_enrollments_one_active_student_year ON enrollments (student_id, academic_year_id) WHERE status IN ('enrolled', 'active');",
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_enrollments_roll_section_year ON enrollments (section_id, academic_year_id, roll_number) WHERE roll_number <> '';",
		...
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_student_attendances_session_student_unique ON student_attendances (session_id, student_id);",
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_attendance_sessions_section_year_date_period ON attendance_sessions (section_id, academic_year_id, date, period_number);",
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_timetable_slots_section_year_term_day_period ON timetable_slots (section_id, academic_year_id, term_id, day_of_week, period_number);",
		"CREATE UNIQUE INDEX IF NOT EXISTS idx_timetable_slots_staff_year_term_day_period ON timetable_slots (staff_id, academic_year_id, term_id, day_of_week, period_number) WHERE COALESCE(staff_id, '') <> '';",
	}
}
